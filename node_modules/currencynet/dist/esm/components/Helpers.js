...
export const fetchUserLoactionCurrencyCode = () => {
...
export const getRate = (from, to) => {
    ...
    const data = parseInt(getCookie(`${to}_${from}`));
...
export const shorten_number = (number, float = 2) => {
    if (number < 1000) {
...
export const output_display = (clientDisplay, value, isfloat = true, shortenCurrency = true) => {
